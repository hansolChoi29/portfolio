...
export default function ModalContent({
  ...
  // 필요하다면 useEffect 등을 여기서 추가할 수 있습니다.
  return (
    <AnimatePresence>
      <motion.div
        ref={modalRef}
          ...
          <div className="flex flex-col text-sm sm:text-xl  text-gray-700 w-full max-w-[800px]">
            ...
            <motion.section {...scrollAnimationProps}>
              ...
              <div className="border-b border-black py-4">
                ...
                <p className="sm:text-base text-sm">
                  유저정보를 이용하여 계정을 찾거나 재설정해줄 수 있도록 구현해
                  주었습니다.
                </p>
              </div>
              <div className="border-b border-black py-4">
              ...
              <div className="py-4">
                ...
                <p className="sm:text-base text-sm">
                  ...
                  user만 문의가 가능하도록 구축하였고 마이페이지에서 확인
                  가능합니다.
                </p>
              </div>
            </motion.section>
            ...
            <section className="flex flex-col gap-24 py-24">
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <p className="sm:text-base text-sm">
                  ...
                  구분하도록 하였습니다. user일 경우, 소셜 로그인 가능하게 하여
                  사용자의 편의를 신경 썼습니다.
                </p>
              </div>
              <div className="flex flex-col gap-2 ">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="sm:text-base text-sm">
                  ...
                  않았던 문제입니다.
                  <br /> 해결방안으로 Supabase 트리거를 이용하여 소셜 로그인 시
                  kakao에서 제공하고 있는 meta데이터 제외한 정보는
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  />
                  <p className="sm:text-base text-sm">
                    정보를 기입하고 아이디찾기 버튼을 클릭하면 조회중으로 바뀌어
                    사용자에게 편의를 제공해 주었습니다.{" "}
                  </p>
                  <Image
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="sm:text-base text-sm">
                  사용자가 비밀번호를 잊어버린 경우, OTP 인증을 통해 비밀번호를
                  안전하게 재설정 가능하도록 구현했습니다.
                </p>
                <div className="flex flex-col items-center gap-2">
                  <Image
