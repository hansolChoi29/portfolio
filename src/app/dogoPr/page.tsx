        ...
        >
          ...
          <div className="flex flex-col  items-center ">
            <div className="flex flex-col  text-lg text-gray-700 w-[800px]">
              ...
              <section className=" border-b py-4">
                <p className="font-bold">3. 모달 기능 구현</p>
                <p>
              ...
              <section className=" border-b py-4">
                <p className="font-bold">4. 문의하기 기능 구현</p>
                <p>
              ...
              <section className="py-4">
                <h1 className="font-bold">진행 과정 : Auth</h1>
                <div>
                  <p className="font-bold">- 로그인 페이지</p>
                  <p>
                ...
                <div>
                  <p className="font-bold">- 회원가입 페이지</p>
                  <p>
                ...
                <div>
                  <p className="font-bold">- 소셜 로그인</p>
                  <p>
              ...
              <section className="border-t py-4">
                <h1 className="font-bold"> 진행 과정 : Modal</h1>
              ...
              <section>
                <h1 className="font-bold"> 진행 과정 : Inquiry</h1>
                <div className="border-b py-4">
